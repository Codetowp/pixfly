...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'pixfly' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'pixfly' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'pixfly' ),
		'cyrillic'     => __( 'Cyrillic', 'pixfly' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'pixfly' ),
		'devanagari'   => __( 'Devanagari', 'pixfly' ),
		'greek'        => __( 'Greek', 'pixfly' ),
		'greek-ext'    => __( 'Greek Extended', 'pixfly' ),
		'khmer'        => __( 'Khmer', 'pixfly' ),
		'latin'        => __( 'Latin', 'pixfly' ),
		'latin-ext'    => __( 'Latin Extended', 'pixfly' ),
		'vietnamese'   => __( 'Vietnamese', 'pixfly' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'pixfly' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'pixfly' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'pixfly' ),
 ...
 */
function pixfly_customizer_library_sanitize_font_choice( $value ) {
	if ( is_int( $value ) ) {
